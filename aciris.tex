...
%\sep J.2 [Physical Sciences and Engineering]: Astronomy \sep D.1.5 [Programming Techniques]: Object Oriented Programming \sep D.2.11 [Software Engineering]: Software Architectures---Data Abstraction \sep D.2.11 [Software Engineering]: Reusable Software---Reusable Libraries
...
%application for building, viewing and modeling broadband spectrophotometric
...
%to Iris. Thus, a user can employ Iris' SED building capabilities while running
...
%the SED from its observed redshift of $z=1.18$ to rest-frame. Before starting a
...
%user saves the filtered, rest-frame SED to a VO-compliant FITS file, which can
