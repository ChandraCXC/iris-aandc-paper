...
Tool), or through a custom file filter plug-in at run time.} \end{center}
\end{figure}
...
In the context of the VAO development of Iris, we adapted the NASA/IPAC Extragalactic
Database (NED) long standing photometry and spectral energy
...
Simple Spectrum Access Protocol (SAMP) standard.
