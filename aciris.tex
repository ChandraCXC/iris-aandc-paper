...
in Iris with other built-in and custom components.},
...
\begin{lstlisting}[style=java,
	caption={This snippet of Java code represents the main interface that all components in Iris have to implement, and how dependencies get injected into the components at run-time.}, 		
	label=lst:component]
package cfa.vo.iris;
